...
public class SightsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        datas.add(new Data(R.string.sights_title_1, R.string.sights_content_1, R.drawable.luqmanhall));
        datas.add(new Data(R.string.sights_title_2, R.string.sights_content_2, R.drawable.octobr));
        datas.add(new Data(R.string.sights_title_3, R.string.sights_content_3, R.drawable.uum));
        datas.add(new Data(R.string.sights_title_4, R.string.sights_content_4, R.drawable.ramsees));
